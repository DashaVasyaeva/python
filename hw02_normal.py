...
list_2 = []
for i in range(10):
    list_1.append(random.randint(-10,100))
for i in list_1:
...
data = input('Введите дату в формате dd.mm.year: ')
data = data.split('.')
...
second_list = list(set(first_list))  # а)
print('Удаление повторений: ', second_list)
third_list = []  # б)
for i in first_list:
    if first_list.count(i) == 1:
        third_list.append(i)
print('Элементы, которые не имеют повторений: ', third_list)
